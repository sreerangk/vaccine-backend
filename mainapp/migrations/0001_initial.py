# Generated by Django 4.2.2 on 2023-06-15 04:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vaccination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.vaccine')),
        ...
        migrations.AddField(
            model_name='patient',
            name='vaccines',
            field=models.ManyToManyField(to='mainapp.vaccine'),
        ),
    ]
